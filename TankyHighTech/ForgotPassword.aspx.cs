        ...
        using (SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["TankyShop"].ConnectionString))
        {
            ...
            if (dt.Rows.Count != 0)
            {
                ...
                cmd1.ExecuteNonQuery();
                 ...
                 String EmailBody = "Hi ," + Username + ",<br/><br/>Click the link below to reset your password<br/> <br/> http://localhost:59180/RecoverPassword.aspx?id=" + myGUID;


                 MailMessage PassRecMail = new MailMessage("tanky.shop1@gmail.com", ToEmailAddress);
                 ...
                 using (SmtpClient client = new SmtpClient())
                 {
                     ...
                     client.Credentials = new NetworkCredential("tanky.shop1@gmail.com", "Tanky.0000");
