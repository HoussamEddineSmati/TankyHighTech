<%@ page language="C#" autoeventwireup="true" inherits="login, App_Web_zlrcjpf3" %>
                            ...
                            <div class="col-lg-6 col-md-6">
                                <div class="login_part_text text-center">
                                    <div class="login_part_text_iner">
                                        ...
                                        <p>
                                            Il y a des progrès dans la science et la technologie
                                    tous les jours, et un bon exemple en est le
                                        </p>
                                    ...
                                    <div class="login_part_form_iner">
                                        ...
                                        <div class="row contact_form">
                                            ...
                                            <div class="col-md-12 form-group">
                                                ...
                                                <asp:Button ID="btnLogin" CssClass="btn_3 " runat="server" Text="log in" OnClick="btnLogin_Click" />
