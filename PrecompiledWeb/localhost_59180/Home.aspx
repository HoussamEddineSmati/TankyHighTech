<%@ page language="C#" autoeventwireup="true" inherits="Home, App_Web_zlrcjpf3" %>
                            ...
                            <div class="row justify-content-between align-items-center">
                                <div class="col-xl-8 col-lg-8 col-md-8 col-sm-8">
                                    <div class="hero__caption">
                                        <h1 data-animation="fadeInLeft" data-delay=".4s" data-duration="2000ms">TANKY SHOP </h1>
                                        <p data-animation="fadeInLeft" data-delay=".7s" data-duration="2000ms">la maison parfaite des fans de haute technologie</p>
                                        <!-- Hero-btn -->
                                        <div class="hero__btn" data-animation="fadeInLeft" data-delay=".8s" data-duration="2000ms">
                                            <a href="signup.aspx" class="btn hero-btn">Shop Now</a>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="single-new-pro mb-30 text-center">
                                <div class="product-img">
                                    <a href="product_details.html">
                                        <img src="assets/img/PC/Pc_Portable2.jpg" /></a>
                                </div>
                                <div class="product-caption">
                                    <h3><a href="Produit.aspx">Ordinateur</a></h3>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
                            <div class="single-new-pro mb-30 text-center">
                                <div class="product-img">
                                    <a href="product_details.html">
                                        <img src="assets/img/PC/HP%20Elite%20Dragonfly%20(9VZ72EA).jpg" />></a>
                                </div>
                                <div class="product-caption">
                                    <h3><a href="Produit.aspx">Composants</a></h3>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
                            <div class="single-new-pro mb-30 text-center">
                                <div class="product-img">
                                    <a href="product_details.html">
                                        <img src="assets/img/CPU/Core%20i5-10400.jpg" />></a>
                                </div>
                                <div class="product-caption">
                                    <h3><a href="product_details.html">Processeur</a></h3>
                                </div>
                            </div>
                        </div>
                    </div>
