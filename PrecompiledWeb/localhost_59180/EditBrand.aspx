<%@ page title="" language="C#" masterpagefile="~/AdminMasterPage.master" autoeventwireup="true" inherits="EditBrand, App_Web_tetqy11e" %>
...
<div class="row">
         ...
         <div class="form-group">
          ...
          <div class="form-group">
                        <asp:Button ID="btnUpdateBrand" CssClass ="genric-btn primary-border circle arrow " runat="server" 
