<%@ page language="C#" autoeventwireup="true" inherits="RecoverPassword, App_Web_zlrcjpf3" %>
                        ...
                        <div class="login_part_form">
                            <div class="login_part_form_iner">
                               ...
                               <asp:Label ID="lblmsg" CssClass ="col-md-2 control-label" runat="server" Font-Bold="True" Font-Size="X-Large"></asp:Label>
                                    ...
                                    <div class="col-md-12 form-group p_star">
                                        <asp:TextBox ID="txtrePass" runat="server" Class="form-control" TextMode="Password" placeholder=" Confirm Your Password " ></asp:TextBox>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidatorrePass" CssClass ="Text-danger" runat="server" ErrorMessage="Enter Your Confirm Password" ControlToValidate="txtrePass" ForeColor="Red"></asp:RequiredFieldValidator>
                                       <asp:CompareValidator ID="CompareValidatorPass" CssClass="Text-dangers" runat="server" ErrorMessage="Confirm password not match...Try again" ForeColor="Red" ControlToCompare="txtrePass" ControlToValidate="txtNewPass"></asp:CompareValidator>

                                    </div>
                                    
                                   <div class="col-md-12 form-group">
                                        <asp:Button ID="btnResetPass"  CssClass ="btn_3 " runat="server" Text="Reset" OnClick="btnResetPass_Click"   />                                        
