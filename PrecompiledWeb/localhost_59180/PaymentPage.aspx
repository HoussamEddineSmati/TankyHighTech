<%@ page title="" language="C#" masterpagefile="~/User.master" autoeventwireup="true" inherits="PaymentPage, App_Web_tetqy11e" %>
        ...
        <div class=" col-lg-6 col-md-8">
            <div class="card p-3">
                ...
                <form onsubmit="event.preventDefault()" class="form-card">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-12"> <input type="submit" value="Purchase" class="btn btn-pay placeicon"> </div>
                    </div>
                </form>
            </div>
        </div>
