<%@ page title="" language="C#" masterpagefile="~/User.master" autoeventwireup="true" inherits="Cart, App_Web_tetqy11e" %>
    ...
    <asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                ...
                <br />
                <br />
                    <button id="btnCart2" runat="server" class="genric-btn info circle arrow pull-right" onserverclick="btnCart2_ServerClick" type="button">
